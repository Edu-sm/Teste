...
export default function Error404() {
    return (
        <BodyColor className="bg-light">
            <section className="container rounded-5  d-flex flex-column text-center erro-container mt-5 justify-content-center" style={{ height: "50rem" }}>
                <img src="/images/meteora.png" className="container pb-5"></img>
                <div className="card justify-content-center container rounded-5 bg-dark" style={{ width: "40rem", height: "30rem" }}>
